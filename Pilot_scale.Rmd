...
ggplot(mol_udvikling_plot, aes(x=key, y=value, fill=Stream, )) +geom_bar(stat="identity",width = 0.5, position=position_dodge())+ labs(x="Species",y="Concentraiton mM")+  
...
pilot_rej_data=ID_8A_8B_rej_plot_2[,c(1,2,21,57,58,59)]
