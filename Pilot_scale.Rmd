...
mol_udvikling$Plads=c("8A Feed","8A Permeat","8B Feed","8B Permeat")

mol_udvikling_plot = mol_udvikling%>%gather(key,value, Cl_mgL, SO4_mgL, Na_mgL, Ca_mgL)
                                            
                                            

ion_plot=ggplot(mol_udvikling_plot, aes(x=Plads, y=value, color=key)) +geom_bar()


ion_plot_bar=ggplot(mol_udvikling_plot, aes(x=key, y=value, fill=Plads, )) +geom_bar(stat="identity",width = 0.5, position=position_dodge())
