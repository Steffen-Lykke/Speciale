...
fit_Clrej_multi = lm(Rej_Cl~SO4_mmol+pH, data = Ion_data_frame)
...
fit_Clrej_multi_cook = lm(Rej_Cl~SO4_mmol+SiO2_ladet, data = Ion_data_frame%>%filter(name!="SPRR_12"))
summary(fit_Clrej_multi_cook)
plot(x=predict(fit_Clrej_multi_cook), y=na.omit(Ion_data_frame$Rej_Cl[-12]),
     xlab='Predicted Values',
     ylab='Actual Values',
     main='Predicted vs. Actual Values',
     abline(a=0, b=1))
