...
# Single Salt Databehandling  {.tabset}
...
axx <- list(
  title = "pH")
axy <- list(
  title = "SiO<sub>2</sub> Concentration <br> [mM]")
axz <- list(
...
#### Silica as function of Cl7SO4 ratio and silica concentration
...
fit_Clrej_multi_cook = lm(Rej_Cl~Cl_anion+Rej_SiO2, data = Ion_data_frame%>%filter(name!="SPRR_8"))
