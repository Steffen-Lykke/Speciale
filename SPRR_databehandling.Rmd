...
Ion_data_frame = Ion_data_frame%>%mutate(anion_total = total_sio2_ladet+2*SO4_mmol+Cl_mmol)
...
fit_Clrej_multi = lm(Rej_Cl~SO4_mmol+total_sio2_ladet, data = Ion_data_frame)
...
fit_Clrej_both_multi = lm(Rej_Cl~SO4_mmol+Cl_mmol+SiO2_mmol, data = Ion_data_frame_both)
...
fit_Clrej_both_multi_2 = lm(Rej_Cl~SO4_mmol+Cl_mmol+SiO2_mmol, data = Ion_data_frame_both)
summary(fit_Clrej_both_multi_2)
plot(x=predict(fit_Clrej_both_multi_2), y=na.omit(Ion_data_frame_both$Rej_Cl),
     xlab='Predicted Values',
     ylab='Actual Values',
     main='Predicted vs. Actual Values',
     abline(a=0, b=1))
