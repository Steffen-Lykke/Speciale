...
```{R 3D plot, eval = FALSE, echo=FALSE, message=FALSE}
...
# c(ux, uy, uz) = u = c(x[2]-x[1], y[2]-y[1], z[2]-z[1])
# c(vx, vy, vz) = v = c(x[3]-x[1], y[3]-y[1], z[3]-z[1])
# 
# 
# u_cross_v = c(u[2]*v[3]-u[3]*v[2], u[3]*v[1]-u[1]*v[3], u[1]*v[2]-u[2]*v[1])
# 
# point  = points[1,]
# normal = u_cross_v
# 
...
# 
# z = (-normal[0] * A$X - normal[1] * A$Y - d) * 1. / normal[2]
# 
...
scatter3D(x, y, z, pch = 18, cex = 2, 
    ...
    xlab = "Cl Ratio", ylab = "Silica Content", zlab = "Cl Rejection",  
    surf = list(x = x.pred, y = y.pred, z = z.pred,  
    facets = NA, fit = fitpoints), main = "Lorte plot")

```

```{r Øve sig på 3D plot}
library(reshape2)
x=SPRR_rejection$Cl_ratio
y=SPRR_rejection$Silica_content
z=SPRR_rejection$Cl

points = data.frame(SPRR_rejection$Cl_ratio,SPRR_rejection$Silica_content,SPRR_rejection$Cl)
colnames(points) = c("Cl.ratio","SiO2.content","Cl.rejection")
my_df <- points
#Vores linear model:
