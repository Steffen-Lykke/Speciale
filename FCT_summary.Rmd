...
pH_plot_facet=ggplot()+geom_line(data=FCT_1A_plc,aes(x=100*(1-(10-sek/60/60*1.02)/10),y=pH0201,color="ID:6A"))+
  geom_line(data=FCT_1B,aes(x=100*(1-(8.5-sek/60/60*1.02)/8.5),y=pH0201,color="ID:6B"))+
  geom_line(data=FCT_2A,aes(x=100*(1-(10-sek/60/60*1.02)/10),y=pH0201,color="ID:7A"))+
  geom_line(data=FCT_2B,aes(x=100*(1-(8.45-sek/60/60*1.02)/8.45),y=pH0201,color="ID:7B"))+
  scale_color_brewer(palette= "Set1")+
  scale_x_continuous(limits=c(0, 90), breaks=c(0,20, 40,60,80 ))+
  scale_y_continuous(limits=c(8, 10.1), breaks=c(8.0,8.5,9,9.5,10 ))+
    labs(x="Water Recovery [%]",y="pH", color="Filtration")

pH_plot_facet
ggplotly(pH_plot_facet)
```
...
### std for silica
FCT_Ion_data_frame$SiO2_rej_std <- c(rep(2,20))
FCT_Ion_data_frame$SiO2_rej_std_p <- ((FCT_Ion_data_frame$SiO2_rej_std/FCT_Ion_data_frame$Perm_SiO2)+(FCT_Ion_data_frame$SiO2_rej_std/FCT_Ion_data_frame$Feed_SiO2))
...
```{R ID: 6_7 Rejection IC, echo=FALSE, message=FALSE}
...
ID_8_11$start_vol=c(10,10,10,10,8.5,8.5,8.45,8.45)
...
Plot af feed concentration samt faktiske feed concentrationer. 
der er fotyndings faktor på 0,7 grundet at systemmet var fyldt op med 5mM MgSO4 i stedet for CT-vand. 

```{R ID: 6_7 plot af feed, echo=FALSE, message=FALSE}
...
#vi laver en feed matrice. 
ID_6_7_data=cbind(Cl_ID8_11_IC_data[,c(1,2,3,7,9)],SO4_ID8_11_IC_data[,c(7,9)],Ca_ID8_11_IC_data[,c(7,9)],Na_ID8_11_IC_data[,c(7,9)],Br_ID8_11_IC_data[,c(7,9)],Mg_ID8_11_IC_data[,c(7,9)],K_ID8_11_IC_data[,c(7,9)])
ID_6_7_Feed = ID_6_7_data%>%filter(Stream=="Feed")

ID_6_7_Feed$start_vol=c(10,10,10,10,10,10,8.5,8.5,8.5,8.45,8.45,8.45)
ID_6_7_Feed$perm_vol = ID_6_7_Feed$Time*1.02
ID_6_7_Feed$Recovery = 100*(1-(ID_6_7_Feed$start_vol-ID_6_7_Feed$perm_vol)/ID_6_7_Feed$start_vol)


ID_6_7_Feed$Cl_mM=ID_6_7_Feed$Cl_mgL/Mw_Cl
ID_6_7_Feed$SO4_mM=ID_6_7_Feed$SO4_mgL/Mw_SO4
ID_6_7_Feed$Ca_mM=ID_6_7_Feed$Ca_mgL/Mw_Ca
ID_6_7_Feed$Na_mM=ID_6_7_Feed$Na_mgL/Mw_Na
ID_6_7_Feed$Br_mM=ID_6_7_Feed$Br_mgL/Mw_Br
ID_6_7_Feed$Mg_mM=ID_6_7_Feed$Mg_mgL/Mw_Mg
ID_6_7_Feed$K_mM=ID_6_7_Feed$K_mgL/Mw_K

#vi mutater den så vi kan plotte den rigtigt.
ID_6_7_Feed_plot = ID_6_7_Feed%>%gather(key,value, Cl_mM,SO4_mM,Ca_mM,#Na_mM,
                                        Br_mM,Mg_mM,K_mM)
ID_6_7_Feed_std_p=c(ID_6_7_Feed$CL_Std_p,
                    ID_6_7_Feed$SO4_Std_p,
                    ID_6_7_Feed$Ca_Std_p,
                    #ID_6_7_Feed$Na_Std_p,
                    ID_6_7_Feed$Br_Std_p,
                    ID_6_7_Feed$Mg_Std_p,
                    ID_6_7_Feed$K_Std_p)

ID_6_7_Feed_plot$std_p=ID_6_7_Feed_std_p


plot_1A_alle=ggplot(ID_6_7_Feed_plot%>%filter(Name=="1A"), aes(x=Recovery, y=value,color= key))+geom_point()+geom_line()+geom_hline(yintercept=0)+
  scale_color_brewer(palette= "Set1")+
  geom_errorbar(aes(ymin=value-(value*std_p), ymax=value+(value*std_p)), width=5,
...
plot_1B_alle=ggplot(ID_6_7_Feed_plot%>%filter(Name=="1B"), aes(x=Recovery, y=value,color= key))+geom_point()+geom_line()+geom_hline(yintercept=0)+
  scale_color_brewer(palette= "Set1")+
  geom_errorbar(aes(ymin=value-(value*std_p), ymax=value+(value*std_p)), width=5,
                 position=position_dodge(0.05))+
    labs(x="Water Recovery %",y="Concentration [mM]", color="")+  
...
plot_2A_alle=ggplot(ID_6_7_Feed_plot%>%filter(Name=="2A"), aes(x=Recovery, y=value,color= key))+geom_point()+geom_line()+geom_hline(yintercept=0)+
  scale_color_brewer(palette= "Set1")+
  geom_errorbar(aes(ymin=value-(value*std_p), ymax=value+(value*std_p)), width=5,
                 position=position_dodge(0.05))+
    labs(x="Water Recovery %",y="Concentration [mM]", color="")+ 
...
plot_2B_alle=ggplot(ID_6_7_Feed_plot%>%filter(Name=="2B"), aes(x=Recovery, y=value,color= key))+geom_point()+geom_line()+geom_hline(yintercept=0)+
  scale_color_brewer(palette= "Set1")+
  geom_errorbar(aes(ymin=value-(value*std_p), ymax=value+(value*std_p)), width=5,
                 position=position_dodge(0.05))+
    labs(x="Water Recovery %",y="Concentration [mM]", color="")+  
...
# det virker næsten dårligere i plotly. 
plot_1A_rej=ggplotly(plot_1A_alle)
plot_1B_rej=ggplotly(plot_1B_alle)
plot_2A_rej=ggplotly(plot_2A_alle)
plot_2B_rej=ggplotly(plot_2B_alle)


#plotly grafer hvis man foretrækker det. 
hejmeddig_1 = subplot(plot_1A_rej,plot_1B_rej,plot_2A_rej,plot_2B_rej,nrows=2)
hejmeddig_1

ID_6_7_Feed_nul=ID_6_7_Feed%>%filter(Time==0)
ID_6_7_Feed_nul$Cl_std_mM=ID_6_7_Feed_nul$Cl_mM*ID_6_7_Feed_nul$CL_Std_p
ID_6_7_Feed_nul$SO4_std_mM=ID_6_7_Feed_nul$SO4_mM*ID_6_7_Feed_nul$SO4_Std_p
ID_6_7_Feed_nul$Ca_std_mM=ID_6_7_Feed_nul$Ca_mM*ID_6_7_Feed_nul$Ca_Std_p
ID_6_7_Feed_nul$Na_std_mM=ID_6_7_Feed_nul$Na_mM*ID_6_7_Feed_nul$Na_Std_p
ID_6_7_Feed_nul$Br_std_mM=ID_6_7_Feed_nul$Br_mM*ID_6_7_Feed_nul$Br_Std_p
ID_6_7_Feed_nul$Mg_std_mM=ID_6_7_Feed_nul$Mg_mM*ID_6_7_Feed_nul$Mg_Std_p
ID_6_7_Feed_nul$K_std_mM=ID_6_7_Feed_nul$K_mM*ID_6_7_Feed_nul$K_Std_p

Feed_0=t(ID_6_7_Feed_nul[,c(1,2,21:27)])
Feed_0_std=t(ID_6_7_Feed_nul[,c(1,2,28:34)])

Feed_0[,c(2,3)]=Feed_0[,c(3,2)]
Feed_0_std[,c(2,3)]=Feed_0_std[,c(3,2)]

Feed_0_1A=as.numeric(Feed_0[,1])

Feed_0_2A=as.numeric(Feed_0[,3])

print(Feed_0_2A/Feed_0_1A)
...
``` 
```{R Feed facet plot, echo=FALSE, message=FALSE}
#først tager vi os af IC data og laver til en nice samlet matrice. 
Mw_Cl=35.45
Mw_SO4=96.06
Mw_Ca=40.078
Mw_Na=22.99
...
Mw_K=39.0983
Mw_SiO2=60.08
ID_6_7_facet=ID_6_7_data

ID_6_7_facet_data = ID_6_7_facet%>%gather(key,value, Cl_mgL,SO4_mgL,Ca_mgL,Na_mgL,
                                        Mg_mgL)
std_p=c(ID_6_7_facet$CL_Std_p,
                    ID_6_7_facet$SO4_Std_p,
                    ID_6_7_facet$Ca_Std_p,
                    ID_6_7_facet$Na_Std_p,
                    ID_6_7_facet$Mg_Std_p)

ID_6_7_facet_data$std_p=std_p
ID_6_7_facet_data=ID_6_7_facet_data[,c(1:3,13:15)]
ID_6_7_facet_data$Mw=c(rep(Mw_Cl,29),rep(Mw_SO4,29),rep(Mw_Ca,29),rep(Mw_Na,29),rep(Mw_Mg,29))
ID_6_7_facet_data$Concentration=ID_6_7_facet_data$value/ID_6_7_facet_data$Mw
ID_6_7_facet_data$key=c(rep("Cl",29),rep("SO4",29),rep("Ca",29),rep("Na",29),rep("Mg",29))
start_volume=c(rep(10,8),rep(10,7),rep(8.5,7),rep(8.45,7)) 
ID_6_7_facet_data$start_vol=c(rep(start_volume,5))
ID_6_7_facet_data$Recovery=100*(1-(ID_6_7_facet_data$start_vol-ID_6_7_facet_data$Time*1.02)/ID_6_7_facet_data$start_vol)
ID_6_7_facet_data[ID_6_7_facet_data == "1A"] <- "ID:6A"
ID_6_7_facet_data[ID_6_7_facet_data == "2A"] <- "ID:7A"
ID_6_7_facet_data[ID_6_7_facet_data == "1B"] <- "ID:6B"
ID_6_7_facet_data[ID_6_7_facet_data == "2B"] <- "ID:7B"
...
Silica_facet_feed=FCT_Ion_data_frame[,c(1:3,15,19,20)]
Silica_facet_perm=FCT_Ion_data_frame[,c(1:2,9,15,19,20)]


colnames(Silica_facet_feed) <- c('Name','Time','SiO2_mgL','start_vol','Recovery', 'std') 
colnames(Silica_facet_perm) <- c('Name','Time','SiO2_mgL','start_vol','Recovery', 'std')
Silica_facet=rbind(Silica_facet_feed,Silica_facet_perm)
Silica_facet$Stream=c(rep("Feed",20),rep("Permeate",20))
Silica_facet_Dunk=FCT_Dunk[,c(3,2,6,1)] #jeg er kommet her til med noget DUNK data RIP
Silica_facet_Dunk$start_vol=c(rep(10,4), rep(8.5,4),rep(10,4), rep(8.45,4))
Silica_facet_Dunk$Recovery=100*(1-(Silica_facet_Dunk$start_vol-Silica_facet_Dunk$time*1.02)/Silica_facet_Dunk$start_vol)
Silica_facet_Dunk$std=2
Silica_facet_Dunk=Silica_facet_Dunk[,c(1:3,5,6,7,4)]
colnames(Silica_facet_Dunk) <-c('Name','Time', 'SiO2_mgL','start_vol','Recovery','std','Stream') 
Silica_facet_Dunk$Stream="Perm spand"
Silica_facet_Dunk$Time[c(3,7,11,15)]=6.1764
Silica_facet=rbind(Silica_facet,Silica_facet_Dunk)

Silica_facet$std_p=Silica_facet$std/Silica_facet$SiO2_mgL

Silica_facet[Silica_facet == "FCT_1A"] <- "ID:6A"
Silica_facet[Silica_facet == "FCT_2A"] <- "ID:7A"
Silica_facet[Silica_facet == "FCT_1B"] <- "ID:6B"
Silica_facet[Silica_facet == "FCT_2B"] <- "ID:7B"


Silica_facet$key="SiO2"
Silica_facet$Mw=Mw_SiO2
Silica_facet$Concentration=Silica_facet$SiO2_mgL/Silica_facet$Mw

Silica_facet_data=Silica_facet[,c(1,2,
                                  7,
                                  9,
                                  3,
                                  8,10,11, 4,5)]
colnames(Silica_facet_data) <-c('Name','Time','Stream','key','value','std_p','Mw','Concentration','start_vol','Recovery') 

Facet_data_FCT=rbind(ID_6_7_facet_data,Silica_facet_data)
Facet_data_FCT$plot=c(rep("Ca, Cl, Mg, SiO2, SO4",87),rep("Na",29),rep("Ca, Cl, Mg, SiO2, SO4",85))

library(RColorBrewer)
my_palette = c(brewer.pal(9, "Set1")[c(1,2,9,3,4,5)])

pølz<- ggplot(data=Facet_data_FCT%>%filter(Stream=="Feed"),aes(x=Recovery,y=Concentration,color=key))+
  geom_point()+geom_line()+scale_colour_manual(values = palette(my_palette))+geom_hline(yintercept=0)+
    geom_errorbar(data=Facet_data_FCT%>%filter(Stream=="Feed"),aes(x=Recovery,ymin=Concentration-(Concentration*std_p), ymax=Concentration+(Concentration*std_p),color=key), width=1, position=position_dodge(0.05))+
    facet_grid(cols=vars(Name), rows=vars(plot),scale="free")+
   scale_x_continuous(limits=c(0, 90), breaks=c(0,20, 40,60,80 ))+labs(x="Water Recovery [%]",y="Concentration [mM]", color="Species")

pølz1<- ggplot(data=Facet_data_FCT%>%filter(Stream=="Feed"),aes(x=Recovery,y=Concentration,color=key))+
  geom_point()+geom_line()+scale_colour_manual(values = palette(my_palette))+geom_hline(yintercept=0)+
    geom_errorbar(data=Facet_data_FCT%>%filter(Stream=="Feed"),aes(x=Recovery,ymin=Concentration-(Concentration*std_p), ymax=Concentration+(Concentration*std_p),color=key), width=1, position=position_dodge(0.05))+
    facet_grid(cols=vars(Name), rows=vars(plot),scale="free")+
   scale_x_continuous(limits=c(0, 90), breaks=c(0,20, 40,60,80 ))+labs(x="Water Recovery [%]",y="Concentration [mM]", color="Species")
...
write.table(Facet_data_FCT,file='data/FCT_concentration.csv',col.names = T,row.names = F,sep="\t")

```


### IC rejection of ions. 
...
ID_8_11$rrej_Mg=ID_8_11$rej_Mg
ID_8_11_rej = ID_8_11%>%gather(key,value, rej_Cl,rej_SO4,rej_Ca,rej_Na,rrej_Mg)
...
plot_1A=ggplot()+
  geom_line(data=ID_8_11_rej%>%filter(Name=="1A"), aes(x=Recovery, y=value,color= key))+
  geom_point(data=ID_8_11_rej%>%filter(Name=="1A"), aes(x=Recovery, y=value,color= key))+
  geom_hline(yintercept=0)+
  scale_color_brewer(palette= "Set1")+
  geom_errorbar(data=ID_8_11_rej%>%filter(Name=="1A"),aes(x=Recovery, ymin=value-(value*rej_std_p), ymax=value+(value*rej_std_p),color= key), width=4,
                 position=position_dodge(0.05))+
geom_point(data=FCT_Ion_data_frame%>%filter(name=="FCT_1A"), aes(x=Recovery, y=rej_SiO2,color='rej_SiO2'))+
 geom_line(data=FCT_Ion_data_frame%>%filter(name=="FCT_1A"), aes(x=Recovery, y=rej_SiO2,color='rej_SiO2'))+
  geom_errorbar(data=FCT_Ion_data_frame%>%filter(name=="FCT_1A"),aes(x=Recovery,ymin=rej_SiO2-(rej_SiO2*SiO2_rej_std_p), ymax=rej_SiO2+(rej_SiO2*SiO2_rej_std_p),color='rej_SiO2'), width=1,
                 position=position_dodge(0.05))+
labs(x="Water Recovery %",y="Rejection %", color="")+  
  scale_y_continuous(limits=c(-65, 105), breaks=c(-60,-40,-20, 0, 20, 40,60,80,100 ))+
  scale_x_continuous(limits=c(0, 90), breaks=c(10, 30,50,70,90 ))+
...
plot_1B=ggplot()+
  geom_line(data=ID_8_11_rej%>%filter(Name=="1B"), aes(x=Recovery, y=value,color= key))+
  geom_point(data=ID_8_11_rej%>%filter(Name=="1B"), aes(x=Recovery, y=value,color= key))+
  geom_hline(yintercept=0)+
  scale_color_brewer(palette= "Set1")+
  geom_errorbar(data=ID_8_11_rej%>%filter(Name=="1B"),aes(x=Recovery, ymin=value-(value*rej_std_p), ymax=value+(value*rej_std_p),color= key), width=4,
                 position=position_dodge(0.05))+
geom_point(data=FCT_Ion_data_frame%>%filter(name=="FCT_1B"), aes(x=Recovery, y=rej_SiO2,color='rej_SiO2'))+
 geom_line(data=FCT_Ion_data_frame%>%filter(name=="FCT_1B"), aes(x=Recovery, y=rej_SiO2,color='rej_SiO2'))+
  geom_errorbar(data=FCT_Ion_data_frame%>%filter(name=="FCT_1B"),aes(x=Recovery,ymin=rej_SiO2-(rej_SiO2*SiO2_rej_std_p), ymax=rej_SiO2+(rej_SiO2*SiO2_rej_std_p),color='rej_SiO2'), width=1,
                 position=position_dodge(0.05))+
labs(x="Water Recovery %",y="Rejection %", color="")+  
  scale_y_continuous(limits=c(-65, 105), breaks=c(-60,-40,-20, 0, 20, 40,60,80,100 ))+
  scale_x_continuous(limits=c(0, 90), breaks=c(10, 30,50,70,90 ))+
...
plot_2A=ggplot()+
  geom_line(data=ID_8_11_rej%>%filter(Name=="2A"), aes(x=Recovery, y=value,color= key))+
  geom_point(data=ID_8_11_rej%>%filter(Name=="2A"), aes(x=Recovery, y=value,color= key))+
  geom_hline(yintercept=0)+
  scale_color_brewer(palette= "Set1")+
  geom_errorbar(data=ID_8_11_rej%>%filter(Name=="2A"),aes(x=Recovery, ymin=value-(value*rej_std_p), ymax=value+(value*rej_std_p),color= key), width=4,
                 position=position_dodge(0.05))+
geom_point(data=FCT_Ion_data_frame%>%filter(name=="FCT_2A"), aes(x=Recovery, y=rej_SiO2,color='rej_SiO2'))+
 geom_line(data=FCT_Ion_data_frame%>%filter(name=="FCT_2A"), aes(x=Recovery, y=rej_SiO2,color='rej_SiO2'))+
  geom_errorbar(data=FCT_Ion_data_frame%>%filter(name=="FCT_2A"),aes(x=Recovery,ymin=rej_SiO2-(rej_SiO2*SiO2_rej_std_p), ymax=rej_SiO2+(rej_SiO2*SiO2_rej_std_p),color='rej_SiO2'), width=1,
                 position=position_dodge(0.05))+
labs(x="Water Recovery %",y="Rejection %", color="")+  
  scale_y_continuous(limits=c(-65, 105), breaks=c(-60,-40,-20, 0, 20, 40,60,80,100 ))+
  scale_x_continuous(limits=c(0, 90), breaks=c(10, 30,50,70,90 ))+
...
plot_2B=ggplot()+
  geom_line(data=ID_8_11_rej%>%filter(Name=="2B"), aes(x=Recovery, y=value,color= key))+
  geom_point(data=ID_8_11_rej%>%filter(Name=="2B"), aes(x=Recovery, y=value,color= key))+
  geom_hline(yintercept=0)+
  scale_color_brewer(palette= "Set1")+
  geom_errorbar(data=ID_8_11_rej%>%filter(Name=="2B"),aes(x=Recovery, ymin=value-(value*rej_std_p), ymax=value+(value*rej_std_p),color= key), width=4,
                 position=position_dodge(0.05))+
geom_point(data=FCT_Ion_data_frame%>%filter(name=="FCT_2B"), aes(x=Recovery, y=rej_SiO2,color='rej_SiO2'))+
 geom_line(data=FCT_Ion_data_frame%>%filter(name=="FCT_2B"), aes(x=Recovery, y=rej_SiO2,color='rej_SiO2'))+
  geom_errorbar(data=FCT_Ion_data_frame%>%filter(name=="FCT_2B"),aes(x=Recovery,ymin=rej_SiO2-(rej_SiO2*SiO2_rej_std_p), ymax=rej_SiO2+(rej_SiO2*SiO2_rej_std_p),color='rej_SiO2'), width=1,
                 position=position_dodge(0.05))+
labs(x="Water Recovery %",y="Rejection %", color="")+  
  scale_y_continuous(limits=c(-65, 105), breaks=c(-60,-40,-20, 0, 20, 40,60,80,100 ))+
  scale_x_continuous(limits=c(0, 90), breaks=c(10, 30,50,70,90 ))+
...
ggarrange(plot_1A,plot_1B, ncol=2, nrow=1, common.legend = TRUE, legend="bottom")#,align = "v")
ggarrange(plot_2A,plot_2B, ncol=2, nrow=1, common.legend = TRUE, legend="bottom")#,align = "v")
ggarrange(plot_1A,plot_1B,plot_2A,plot_2B, ncol=4, nrow=1, common.legend = TRUE, legend="bottom")#,align = "v")
plot_1A=ggplotly(plot_1A)
plot_1B=ggplotly(plot_1B)
plot_2A=ggplotly(plot_2A)
plot_2B=ggplotly(plot_2B)


#plotly grafer hvis man foretrækker det. 
hejmeddig_1 = subplot(plot_1A,plot_1B,plot_2A,plot_2B,nrows=2)
hejmeddig_1


```

```{R facet rejection ALLE, echo=FALSE, message=FALSE}

ioner=c(expression(Ca^{textstyle("2+")}),expression(Cl^{textstyle("-")}),expression(Mg^{textstyle("2+")}),expression(Na^{textstyle("+")}),expression(SiO[2]),expression(SO[4]^{textstyle("2-")}))
colors2=c( 
  '#d62728',  # brick red
  '#1f77b4',  # muted blue 
   '#7f7f7f',  # middle gray
...
ioner_data=ID_8_11_rej[,c(1,2,33,44:46)]
Silica_data_rej=FCT_Ion_data_frame[,c(1,2,19,16,21)]
Silica_data_rej$key="SiO2"
Silica_data_rej=Silica_data_rej[,c(1,2,3,6,4,5)]
colnames(Silica_data_rej) <-c('Name','Time','Recovery','ion','Rejection','std_p') 
colnames(ioner_data) <-c('Name','Time','Recovery','ion','Rejection','std_p') 
ioner_data$ion=c(rep("Cl",8),rep("SO4",8),rep("Ca",8),rep("Na",8),rep("Mg",8))


Silica_data_rej[Silica_data_rej == "FCT_1A"] <- "ID:6A"
Silica_data_rej[Silica_data_rej == "FCT_2A"] <- "ID:7A"
Silica_data_rej[Silica_data_rej == "FCT_1B"] <- "ID:6B"
Silica_data_rej[Silica_data_rej == "FCT_2B"] <- "ID:7B"

ioner_data[ioner_data == "1A"] <- "ID:6A"
ioner_data[ioner_data == "2A"] <- "ID:7A"
ioner_data[ioner_data == "1B"] <- "ID:6B"
ioner_data[ioner_data == "2B"] <- "ID:7B"


rej_facet_data=rbind(ioner_data,Silica_data_rej)


pølz2<- ggplot(data=rej_facet_data,aes(x=Recovery,y=Rejection,color=ion))+
  geom_point()+geom_line()+labs(colour = "Species")+scale_color_manual(labels = ioner, values =colors2)+theme(legend.text.align=0)+geom_hline(yintercept=0)+
    geom_errorbar(data=rej_facet_data,aes(x=Recovery,ymin=Rejection-(Rejection*std_p), ymax=Rejection+(Rejection*std_p),color=ion), width=1, position=position_dodge(0.05))+
    facet_grid(cols=vars(Name),scale="free")+
  scale_y_continuous(limits=c(-60, 105), breaks=c(-60,-40,-20,0,20, 40,60,80,100 ))+
   scale_x_continuous(limits=c(0, 90), breaks=c(0,20, 40,60,80 ))+labs(x="Water Recovery [%]",y="Rejection [%]", color="Species")

pølz2
ggplotly(pølz2)


write.table(rej_facet_data,file='data/FCT_rejection.csv',col.names = T,row.names = F,sep="\t")
...
```{R conc magic, echo=FALSE, message=FALSE}

feed_nul=Facet_data_FCT%>%filter(Stream=="Feed", Time==0)

Perm_spand=Facet_data_FCT%>%filter(Stream=="Perm spand")
volume_vector=c(4,4.5,
                4,4.5,
                4,3.22,
                4,3.18)

Perm_spand$volume=c(rep(volume_vector,5),2,4,6,2.5,
                    2,4,6,1.22,2,4,6,2.5,2,4,6,1.18)
Perm_spand$conc_L=Perm_spand$volume*Perm_spand$Concentration

accum_permeate=aggregate(Perm_spand$conc_L, by=list(Category=Perm_spand$Name,Perm_spand$key), FUN=sum)


accum_permeate=as.data.frame(accum_permeate)
accum_permeate$perm_vol=c(rep(c(8.5,7.22,8.5,7.18),6))
accum_permeate$Concentration=accum_permeate$x/accum_permeate$perm_vol
accum_permeate=accum_permeate[,c(1,2,5)]
feed_nul_sej=feed_nul[,c(1,4,8)]
colnames(accum_permeate) <-c('Name','key','Concentration') 
feed_nul_sej[feed_nul_sej == "ID:6A" ] <- "ID:6A - Feed"
feed_nul_sej[feed_nul_sej == "ID:7A" ] <- "ID:7A - Feed"
feed_nul_sej[feed_nul_sej == "ID:6B" ] <- "ID:6B - Feed"
feed_nul_sej[feed_nul_sej == "ID:7B" ] <- "ID:7B - Feed"

accum_permeate[accum_permeate == "ID:6A"] <- "ID:6A - Permeate"
accum_permeate[accum_permeate == "ID:7A"] <- "ID:7A - Permeate"
accum_permeate[accum_permeate == "ID:6B"] <- "ID:6B - Permeate"
accum_permeate[accum_permeate == "ID:7B"] <- "ID:7B - Permeate"

vigtig_conc_data=rbind(accum_permeate,feed_nul_sej)
vigtig_conc_data$filtration=vigtig_conc_data$Name

vigtig_conc_data$filtration[vigtig_conc_data$filtration == "ID:6A - Feed"]<- "ID:6"
vigtig_conc_data$filtration[vigtig_conc_data$filtration == "ID:7A - Feed"]<- "ID:7"
vigtig_conc_data$filtration[vigtig_conc_data$filtration == "ID:6B - Feed"]<- "ID:6"
vigtig_conc_data$filtration[vigtig_conc_data$filtration == "ID:7B - Feed"]<- "ID:7"
vigtig_conc_data$filtration[vigtig_conc_data$filtration == "ID:6A - Permeate"]<- "ID:6"
vigtig_conc_data$filtration[vigtig_conc_data$filtration == "ID:7A - Permeate"]<- "ID:7"
vigtig_conc_data$filtration[vigtig_conc_data$filtration == "ID:6B - Permeate"]<- "ID:6"
vigtig_conc_data$filtration[vigtig_conc_data$filtration == "ID:7B - Permeate"]<- "ID:7"

#FCT_ion_plot=ggplot(vigtig_conc_data%>%filter(filtration=="ID:6"), aes(x=key, y=Concentration, color=key)) +geom_bar(stat="identity",width = 0.5, position=position_dodge())


FCT_conc_6=ggplot(vigtig_conc_data%>%filter(filtration=="ID:6"), aes(x=key, y=Concentration, fill=Name, )) +geom_bar(stat="identity",width = 0.5, position=position_dodge())+ labs(x="Species",y="Concentration [mM]")+  
  ggtitle("ID:6A/6B")

FCT_conc_6

FCT_conc_7=ggplot(vigtig_conc_data%>%filter(filtration=="ID:7"), aes(x=key, y=Concentration, fill=Name, )) +geom_bar(stat="identity",width = 0.5, position=position_dodge())+ labs(x="Species",y="Concentration [mM]")+  
  ggtitle("ID:7A/7B")
...
#udregning af rejection: 
rejection_1_fil6=(1-(vigtig_conc_data[c(1,5,9,13,17,21),]$Concentration/vigtig_conc_data[c(33,25,41,37,45,29),]$Concentration))*100
rejection_2_fil6=(1-(vigtig_conc_data[c(2,6,10,14,18,22),]$Concentration/vigtig_conc_data[c(33,25,41,37,45,29),]$Concentration))*100

rejection_1_fil7=(1-(vigtig_conc_data[c(3,7,11,15,19,23),]$Concentration/vigtig_conc_data[c(34,26,42,38,46,30),]$Concentration))*100
rejection_2_fil7=(1-(vigtig_conc_data[c(4,8,12,16,20,24),]$Concentration/vigtig_conc_data[c(34,26,42,38,46,30),]$Concentration))*100

rejection_total=cbind(c("Ca","Cl","Mg","Na","SiO2","SO4"),rejection_1_fil6,rejection_2_fil6,rejection_1_fil7,rejection_2_fil7) 
colnames(rejection_total)=c('ion','ID:6 1 filtration', 'ID:6 2 filtration','ID:7 1 filtration','ID:7 2 filtration')
rejection_total

ppølz<- ggplot(data=Facet_data_FCT%>%filter(Stream=="Permeate"),aes(x=Recovery,y=Concentration,color=key))+
  geom_point()+geom_line()+scale_colour_manual(values = palette(my_palette))+geom_hline(yintercept=0)+
    geom_errorbar(data=Facet_data_FCT%>%filter(Stream=="Permeate"),aes(x=Recovery,ymin=Concentration-(Concentration*std_p), ymax=Concentration+(Concentration*std_p),color=key), width=1, position=position_dodge(0.05))+
    facet_grid(cols=vars(Name), rows=vars(plot),scale="free")+
   scale_x_continuous(limits=c(0, 90), breaks=c(0,20, 40,60,80 ))+labs(x="Water Recovery [%]",y="Concentration [mM]", color="Species")
...
```{R conc fusk, echo=FALSE, message=FALSE}

#Vi prøver med ren fusk 
#6A permeat burde = 6B feed, så vi "fitter" den 

factor_snyd_6=((vigtig_conc_data[c(1,5,9,13,17,21),]$Concentration/vigtig_conc_data[c(35,27,43,39,47,31),]$Concentration))

factor_snyd_7=((vigtig_conc_data[c(3,7,11,15,19,23),]$Concentration/vigtig_conc_data[c(36,28,44,40,48,32),]$Concentration))

#det går dårligt med snyd. 

#vI LADER SOM OM BFEED = B_PERMEAT, OG REGNER REJECTION FRA 1 FILTRERING
rejection_1_fil6=(1-(vigtig_conc_data[c(35,27,43,39,46,31),]$Concentration/vigtig_conc_data[c(33,25,41,37,45,29),]$Concentration))*100
#rejection_2_fil6=(1-(vigtig_conc_data[c(2,6,10,14,18,22),]$Concentration/vigtig_conc_data[c(33,25,41,37,45,29),]$Concentration))*100

rejection_1_fil7=(1-(vigtig_conc_data[c(36,28,44,40,48,32),]$Concentration/vigtig_conc_data[c(34,26,42,38,47,30),]$Concentration))*100
#rejection_2_fil7=(1-(vigtig_conc_data[c(4,8,12,16,20,24),]$Concentration/vigtig_conc_data[c(34,26,42,38,46,30),]$Concentration))*100
```

```{R mol, echo=FALSE, message=FALSE}

feed_nul_sej=feed_nul[,c(1,4,8,9)]
feed_nul_sej$conc_mol=feed_nul_sej$Concentration
