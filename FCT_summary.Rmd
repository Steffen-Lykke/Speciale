...
ggplot()+geom_line(data=FCT_1A_plc,aes(x=100*(1-(10-sek/60/60*1.02)/10),y=pH0201,color="ID:6A"))+
  geom_line(data=FCT_1B,aes(x=100*(1-(10-sek/60/60*1.02)/10),y=pH0201,color="ID:6B"))+
  geom_line(data=FCT_2A,aes(x=100*(1-(10-sek/60/60*1.02)/10),y=pH0201,color="ID:7A"))+
  geom_line(data=FCT_2B,aes(x=100*(1-(10-sek/60/60*1.02)/10),y=pH0201,color="ID:7B"))+
...
accum_permeate=aggregate(Perm_spand$Concentration, by=list(Category=Perm_spand$Name,Perm_spand$key), FUN=sum)
...
accum_permeate[accum_permeate == "ID:6B"] <- "ID:6A - Permeate"
