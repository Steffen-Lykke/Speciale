...
```{R FCT_2B_PLC, eval=FALSE, include=FALSE}
FCT_raw = read_delim("data/FCT/FCT_2B_28-03-2022 085424.csv",delim = ",", escape_double = FALSE, trim_ws = TRUE, skip = 3) #Hente data og få det til passe ned i en tabel
