...
```{R teo mod exp  IC, message=FALSE, include=FALSE}
...
IC_nul_data_feed$Stream=c(rep("Experimental",3))


IC_nul_data_feed_4=c("ID:1",0,"Theoretical", 2.5,0.7,11.77,0.4,0.7)
IC_nul_data_feed_5=c("ID:2",0,"Theoretical", 2.5,0.7,14.76,0.4,0.7)
IC_nul_data_feed_6=c("ID:3",0,"Theoretical", 2.5,0.7,16.63,0.4,0.7)
...
colnames(IC_nul_data_feed) = c("Name", "Time", "Type", "Cl", "SO4", "Na", "Ca", "SiO2")

IC_nul_data_feed_plot = IC_nul_data_feed%>%gather(key,value, Cl, SO4, Na, Ca, SiO2)
``` 
...
ID_1_feed_start=ggplot(IC_nul_data_feed_plot%>%filter(Name=="ID:1"), aes(x=key, y=value, fill=Type, )) +geom_bar(stat="identity",width = 0.5, position=position_dodge())+ labs(x="Species",y="Concentration mM")+ 
  scale_y_continuous(limits=c(0, 15.5),breaks=c(0, 2, 4,6,8,10,12,14 ))+
