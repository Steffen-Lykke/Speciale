...
Facet_data[Facet_data == "ID:1"] <- "ID:1 - pH 9.3"
Facet_data[Facet_data == "ID:2"] <- "ID:2 - pH 10.2"
Facet_data[Facet_data == "ID:3"] <- "ID:3 - pH 10.5"
...
nice_plot = ggplot(data=Facet_data%>%filter(Stream=="Feed"),aes(x=Recovery,y=Value,color=ion))+
  geom_point()+geom_line()+scale_color_manual(labels = ioner, values =colors2)+
    ...
    facet_grid(cols=vars(Name),row=vars(plot),scale="free")+theme(legend.text.align=0)+
...
perm_plot = ggplot(data=Facet_data%>%filter(Stream=="Permeate"),aes(x=Recovery,y=Value,color=ion))+
  geom_point()+geom_line()+scale_color_brewer(palette= "Set1")+
    geom_errorbar(data=Facet_data%>%filter(Stream=="Permeate"),aes(x=Recovery,ymin=Value-(Value*Std), ymax=Value+(Value*Std),color=ion), width=1, position=position_dodge(0.05))+
...
write.table(Facet_data,file='data/Multisalt_concentration.csv',col.names = T,row.names = F,sep="\t")
...
colors2=c( 
  ...
  geom_hline(yintercept=0)+
 scale_color_manual(labels = ioner, values =colors2)+
...
Facet_data_rej[Facet_data_rej == "ID:1"] <- "ID:1 - pH 9.3"
Facet_data_rej[Facet_data_rej == "ID:2"] <- "ID:2 - pH 10.2"
Facet_data_rej[Facet_data_rej == "ID:3"] <- "ID:3 - pH 10.5"


nice_plot_rej = ggplot(data=Facet_data_rej,aes(x=Recovery,y=Value,color=ion))+
  geom_point()+geom_line()+scale_color_manual(labels = ioner, values =colors2)+geom_hline(yintercept=0)+
  ...
  scale_x_continuous(limits=c(0, 90), breaks=c(20, 40,60,80 ))+
  scale_y_continuous(limits=c(-60, 110), breaks=c(-60,-40,-20, 0, 20, 40,60,80,100 ))+theme(legend.text.align=0)+
...
write.table(Facet_data_rej,file='data/multi_salt_rejection.csv',col.names = T,row.names = F,sep="\t")
...
Anion_data=Facet_data$Value[40:78]+Facet_data$Value[c(157:170,173:197)]
Cl_data=Facet_data[1:39,]
SO4_SIO2=Cl_data
SO4_SIO2$Value=Anion_data
SO4_SIO2$ion="SO4, SiO2"

CL_anion_data=rbind(Cl_data,SO4_SIO2)

anion_plot = ggplot(data=CL_anion_data%>%filter(Stream=="Feed"),aes(x=Recovery,y=Value,color=ion))+
  geom_point()+geom_line()+scale_color_brewer(palette= "Set1")+geom_hline(yintercept=0)+
    #geom_errorbar(data=Facet_data_rej,aes(x=Recovery,ymin=Value-(Value*Std), ymax=Value+(Value*Std),color=ion), width=1, position=position_dodge(0.05))+
  #scale_x_continuous(limits=c(0, 90), breaks=c(20, 40,60,80 ))+
 # scale_y_continuous(limits=c(-60, 110), breaks=c(-60,-40,-20, 0, 20, 40,60,80,100 ))+
    facet_grid(cols=vars(Name),scale="free")+labs(x="Water Recovery [%]",y="Concentration [mM]", color="Species")
anion_plot

ratio_data=CL_anion_data$Value[1:39]/(CL_anion_data$Value[1:39]+CL_anion_data$Value[40:78])

ratio_CL_data=Cl_data
ratio_CL_data$ratio=ratio_data

ratio_plot = ggplot(data=ratio_CL_data%>%filter(Stream=="Feed"),aes(x=Recovery,y=ratio*100, color=Name))+
  geom_point()+geom_line()+scale_color_brewer(palette= "Set1")+geom_hline(yintercept=0)+
    #geom_errorbar(data=Facet_data_rej,aes(x=Recovery,ymin=Value-(Value*Std), ymax=Value+(Value*Std),color=ion), width=1, position=position_dodge(0.05))+
  scale_x_continuous(limits=c(0, 90), breaks=c(0,20, 40,60,80 ))+
  scale_y_continuous(limits=c(0, 80), breaks=c( 0, 20, 40,60,80 ))+
    labs(x="Water Recovery [%]",y="Cl / SO4+SIO2 ratio [%]", color="Filtration")
ratio_plot
...
Cl_SO4_ratio=CL_anion_data$Value[1:39]/(CL_anion_data$Value[1:39]+Facet_data$Value[40:78])
ratio_CL_data$ratio_SO4=Cl_SO4_ratio

SO4_ratio_plot = ggplot(data=ratio_CL_data%>%filter(Stream=="Feed"),aes(x=Recovery,y=ratio_SO4*100, color=Name))+
  geom_point()+geom_line()+scale_color_brewer(palette= "Set1")+geom_hline(yintercept=0)+
    #geom_errorbar(data=Facet_data_rej,aes(x=Recovery,ymin=Value-(Value*Std), ymax=Value+(Value*Std),color=ion), width=1, position=position_dodge(0.05))+
  scale_x_continuous(limits=c(0, 90), breaks=c(0,20, 40,60,80 ))+
  scale_y_continuous(limits=c(0, 90), breaks=c( 0, 20, 40,60,80 ))+
    labs(x="Water Recovery [%]",y="Cl / SO4 ratio [%]", color="Filtration")
SO4_ratio_plot


ggplot(data=Facet_data_rej%>%filter(ion=="Cl"),aes(x=Recovery,y=Value, color=Name))+
  geom_point()+geom_line()+scale_color_brewer(palette= "Set1")+geom_hline(yintercept=0)+
    #geom_errorbar(data=Facet_data_rej,aes(x=Recovery,ymin=Value-(Value*Std), ymax=Value+(Value*Std),color=ion), width=1, position=position_dodge(0.05))+
  scale_x_continuous(limits=c(0, 90), breaks=c(0,20, 40,60,80 ))+
  scale_y_continuous(limits=c(0, 90), breaks=c( 0, 20, 40,60,80 ))+
    labs(x="Water Recovery [%]",y="Cl rejection [%]", color="Filtration")
