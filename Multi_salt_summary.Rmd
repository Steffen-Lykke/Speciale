...
ggplot(data = si_bi, aes(x=Silica,y=bicarb))+geom_point(aes(x=Silica,y=bicarb,color=origin))+geom_smooth(method=glm,formula = y~x)
...
rej_9.2=ggplot(C, aes(x=time, y=value,color= key))+geom_point()+geom_line()+geom_hline(yintercept=0)+
...
rej_10=ggplot(C, aes(x=time, y=value,color= key))+geom_point()+geom_line()+geom_hline(yintercept=0)+
  scale_color_brewer(palette= "Set1")+scale_y_continuous(limits = c(-0.6,1))+
  labs(x="Time [h]",y="Rejection", color="")+xlim(c(0,NA))+
  ggtitle("pH 10")
rej_10
...
rejec_10.5=ggplot(C, aes(x=time, y=value,color= key))+geom_point()+geom_line()+geom_hline(yintercept=0)+
  scale_color_brewer(palette= "Set1")+scale_y_continuous(limits = c(-0.6,1))+
  labs(x="Time [h]",y="Rejection", color="")+xlim(c(0,NA))+
  ggtitle("pH 10.5")
rejec_10.5
