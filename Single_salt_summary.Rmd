...
```{R Na2OSiO2 plot conductivity, include=TRUE, message=FALSE}
...
```{R Na2OSiO2 plot concentration, include=TRUE, message=FALSE}
 #Na2OSiO2 data 
...
-> mangler at kommentere på SiO2 rejection. 
...
<h3> Mangler PH sammenligning </h3>
