...
The concentration of Si was measured with Hack kits, and the concentration of Na was measured with IC analysis, similar to the NaCl and the CaCl2 experiments. 
...
ggplot()+
  ...
  labs(x="Time [h]",y=" Concentration [mg/L]")+
  ggtitle("Concentration,  Dot = Si, Triangle = Na")
