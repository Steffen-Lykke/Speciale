...
Sodium and Chloride data is presented together where Chloride is sodium is represented by 

 plot indicate some increase in concentration for both feed and permeate
...
ggplot()+
  ...
  labs(x="Time [h]",y="Chloride concentration [mg/L]")+
  ylim(0,135)+
  ggtitle("Concentration and rejection")+
  ...
  labs(x="Time [h]",y="Sodium concentration [mg/L]")+
  ylim(0,135)+
...
ggplot()+
  geom_point(data=CaCl2_IC_data, aes(x=time, y=Chloride, col=Stream), shape= 9)+
  geom_point(data=CaCl2_Feed[-1,], aes(x=CaCl2_Feed$time[-1], y=CaCl2_rej_Cl))+
  ggtitle("Chloride concentration and rejection")
...
ggplot()+
  ...
  scale_color_manual(values=c("CaCl2 R Ca"="red", "CaCl2 R Cl"="blue", "NaCl R Na"="green", "NaCl R Cl"="orange"),labels=c("CaCl2 R Ca", "CaCl2 R Cl", "NaCl R Na", "NaCl R Cl"))+
