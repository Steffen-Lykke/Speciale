...
ggplot()+
  ...
  labs(x="Time [h]",y=" Concentration [mg/L]")+
  ggtitle("Na and Si concentration")
...
ggplot()+
  ...
  geom_point(data=SiO2_Feed[-1,], aes(x=SiO2_Feed$time[-1], y=SiO2_rej_Si,color="SiO2 R Si"))+
  #geom_point(data=SiO2,aes(x=tid, y=SiO2_rejection,color="R SiO2 "))+
  scale_color_manual(values=c("CaCl2 R Ca"="red", "CaCl2 R Cl"="blue", "NaCl R Na"="green", "NaCl R Cl"="orange", "SiO2 R Na"="black", "SiO2 R Si"="purple"),labels=c("CaCl2 R Ca", "CaCl2 R Cl", "NaCl R Na", "NaCl R Cl", "SiO2 R Na", "SiO2 R Si"))+
