...
ion_plot2=ggplot(ICR_plot%>%filter(ion!="Ca"&ion!="sio2"), aes(fill=plads, y=mM, x=ion)) + 
    geom_bar(position="dodge", stat="identity")+scale_color_brewer(palette= "Set1")
ggplotly(ion_plot2)

ion_plot3=ggplot(ICR_plot%>%filter(ion=="Ca"|ion=="sio2"), aes(fill=plads, y=mM, x=ion)) + 
    geom_bar(position="dodge", stat="identity")
