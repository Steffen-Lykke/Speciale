...
```{R import af data god, echo=FALSE, message=FALSE}


SPRR_data <- read_excel("data/SPRR/SPRR_analysesvar_samlet.xlsx",3,col_names = T,
                        col_types=c("numeric","text","text","text","text","numeric","numeric","numeric","numeric","numeric","numeric"))
str(SPRR_data)
...
```{R Plot af Silica subplots_2, echo=FALSE, message=FALSE}
...
```{R Plot af Silica subplots_4, echo=FALSE, message=FALSE}
...
fig_1 <- SPRR_data %>% filter(Stream=="Rejection",Silica_content=="75")%>%
  plot_ly(x=~Cl_ratio,
      ...
      layout(
        #title="silica, pH 9.25, silica 75 mg/L",
         yaxis=list(title="Rejection Chloride",range=c(0,100)),
        xaxis=list(title="Chloride content %") )
...
fig_1 <- SPRR_data %>% filter(Stream=="Rejection",Silica_content=="75")%>%
  plot_ly(x=~Cl_ratio,
      ...
      layout(
        #title="silica, pH 9.25, silica 75 mg/L",
         yaxis=list(title="Rejection Sulphate",range=c(0,100)),
        xaxis=list(title="Chloride content %") )
...
fig_1 <- SPRR_data %>% filter(Stream=="Rejection",Silica_content=="75")%>%
  plot_ly(x=~Cl_ratio,
      ...
      layout(
        #title="silica, pH 9.25, silica 75 mg/L",
         yaxis=list(title="Rejection Bicarbonate",range=c(0,100)),
        xaxis=list(title="Chloride content %") )
