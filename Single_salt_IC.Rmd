...
ggplotly(ggplot(SS_tot_plot,aes(x=recovery,y=value,color=ion))+geom_point()+geom_line()+ylim(0,NA)+facet_grid(cols=vars(exp),row =vars(var),scale="free",switch=NULL))
