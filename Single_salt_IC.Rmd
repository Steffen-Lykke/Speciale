...
SS_tot_plot$ion=c(rep("Na",42),rep("Cl",42),rep("SiO2",42),rep("Ca",42))
SS_tot_plot$var=c(rep("Concentration",84),rep("Rejection",84))

ggplot(SS_tot_plot,aes(x=recovery,y=value,color=ion))+geom_point()+geom_line()+facet_grid(cols=vars(exp),row =vars(var))
