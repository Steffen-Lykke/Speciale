...
fig_NaCl_Cl <- plot_ly(data=NaCl_IC_data[1:16,], x=~time,
          y=~(Chloride/35.45),
         color=~Stream,
...
fig_NaCl_Na <- plot_ly(data=NaCl_IC_data[1:16,], x=~time,
          y=~(Sodium/22.99),
         color=~Stream,
          type='scatter',mode='lines+markers',
          colors=c(colors[1],colors[2],colors[3]))  %>%
...
fig_CaCl2_Cl <- plot_ly(data=CaCl2_IC_data[1:16,], x=~time,
          y=~(Chloride/35.45),
         color=~Stream,
          type='scatter',mode='lines+markers',
          colors=c(colors[1],colors[2],colors[3]),
...
fig_CaCl2_Ca <- plot_ly(data=CaCl2_IC_data[1:16,], x=~time,
          y=~(Calcium/40.078),
         color=~Stream,
          type='scatter',mode='lines+markers',
          colors=c(colors[1],colors[2],colors[3]))  %>%
...
fig_SiO2_Si <- plot_ly(data=SiO2_IC_data[1:16,], x=~time,
          y=~(Silica/60.08),
         color=~Stream,
          type='scatter',mode='lines+markers',
          colors=c(colors[1],colors[2],colors[3]),
...
fig_SiO2_Na <- plot_ly(data=SiO2_IC_data[1:16,], x=~time,
          y=~(Sodium/22.99),
         color=~Stream,
          type='scatter',mode='lines+markers',
          colors=c(colors[1],colors[2],colors[3]))  %>%
...
fig_2 <- subplot(fig_NaCl,fig_CaCL2, fig_SiO2,fig_MgSO4
...
fig_pH <- plot_ly(data=dat_NaCl,x=~sek/3600,
          y=~pH0201,
          type='scatter',mode='lines+markers',
          colors=colors[1], name = "pH NaCl") %>%
      add_trace(data=dat_CaCl2,x=~sek/3600,
          y=~pH0201,
          type='scatter',mode='lines+markers',
          colors=colors[2], name = "pH CaCl2") %>%
      add_trace(data=dat_SiO2,x=~sek/3600,
          y=~pH0201,
          type='scatter',mode='lines+markers',
