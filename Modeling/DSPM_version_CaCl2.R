...
total_df=list(ENP_df_Cl,ENP_df_Ca)
n=2
while (n<=dybde) {
...
colnames(all_c)=c("Cl","Ca","pos","X")
all_c=all_c%>%mutate(ladning=(-Cl+2*Ca)+X)
plot_all=all_c%>%gather(key="key",value="value",Cl,Ca)
