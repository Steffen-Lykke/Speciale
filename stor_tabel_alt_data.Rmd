...
authentic_synthetic_plot=Rejection_data_samlet%>%filter(Species=="Cl"|Species=="SiO2")%>%filter(A_B!="B")%>%
...
authentic_synthetic_plot
ggplotly(authentic_synthetic_plot)
...
concentration_Feed_plot=concentration_data_samlet%>%filter(Stream=="Feed")%>%filter(Species=="Cl"|Species=="SiO2"|Species=="SO4")%>%filter(Filtration!="ID:5B")%>%
