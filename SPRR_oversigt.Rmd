...
```{r no. 2 data, eval=FALSE, include=FALSE}
...
```{r no. 2 plot, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r no. 3 data, eval=FALSE, include=FALSE}
...
```{r no. 3 plot, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r no. 11 data, eval=FALSE, include=FALSE}
...
```{r no. 11 plot, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
